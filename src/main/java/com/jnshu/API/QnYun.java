...
public class QnYun {
    private static Logger logger = LoggerFactory.getLogger(QnYun.class);
    ...
    QnYun(String accessKeyId, String accessKeySecret, String bucketname, String fileUrl, String endpoint) {
